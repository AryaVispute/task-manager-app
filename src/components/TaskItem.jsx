...
const TaskItem = ({ task, onToggle, onUpdateTitle, onDelete }) => {
  ...
  return (
    <div className="flex items-center gap-4 p-4 mb-3 rounded-[1.5rem] bg-white border-2 border-gray-100 hover:border-brand-blue/30 transition-all group shadow-sm">
      ...
      {isEditing ? (
        ...
        <div className="flex-1 min-w-0" onClick={() => setIsEditing(true)}>
          ...
          <span className="text-[11px] font-medium text-gray-500 italic mt-0.5 block">
        ...
        {isEditing ? (
          ...
          <>
            <button 
              ...
              className="p-2 text-gray-400 hover:text-[#FFCB61] hover:bg-[#FFCB61]/5 rounded-xl transition-all"
            >
            ...
            <button 
              ...
              className="p-2 text-gray-400 hover:text-[#EA5B6F] hover:bg-[#EA5B6F]/5 rounded-xl transition-all"
            >
